...
public class FragmentStepDetails extends Fragment implements ExoPlayer.EventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        step_description = (TextView) RootView.findViewById(R.id.step_desc);
        videoPlayerView = (SimpleExoPlayerView) RootView.findViewById(R.id.videoPlayer_view);
        pbBuffering = (ProgressBar) RootView.findViewById(R.id.buffering_pb);
        imageView = (ImageView) RootView.findViewById(R.id.imageView2_iV);
        ...
        if (stepModel != null) {
            ...
            if ((stepModel.getVideoURL() == null) || (stepModel.getThumbnailURL() == null)) {
                ...
                if (stepModel.getThumbnailURL() != null
                        ...
                        && !com.example.android.body.TextUtils.getExtension(stepModel.getThumbnailURL()).equalsIgnoreCase("mp4")) {
